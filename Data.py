...
MAX_LEVEL = 70   # 7 years × 10 levels
...
XP_TO_NEXT = {
    ...
    51: 5100, 52: 5200, 53: 5300, 54: 5400, 55: 5500,
    56: 5600, 57: 5700, 58: 5800, 59: 5900, 60: 6000,
    61: 6100, 62: 6200, 63: 6300, 64: 6400, 65: 6500,
    66: 6600, 67: 6700, 68: 6800, 69: 6900,
    70: None,   # absolute max
}
...
# Level range per year (start inclusive, end inclusive)
YEAR_LEVEL_RANGE = {
    1: (1, 10),
    2: (11, 20),
    3: (21, 30),
...
# Attribute cap grows per year
ATTRIBUTE_CAP_BY_YEAR = {
    1: 10, 2: 12, 3: 14, 4: 16,
    5: 18, 6: 20, 7: 22,
}

# How many spells the player can know at once
SPELL_CAP_BY_YEAR = {
    1: 5, 2: 7, 3: 9, 4: 11,
    5: 13, 6: 15, 7: 17,
}

# Year transition rewards
